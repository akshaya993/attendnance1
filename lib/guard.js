...
export const getActiveSession = cache(async () => {
  ...
  // Number() on BOTH sides is not decoration: session_epoch is a BIGINT and
  // node-postgres returns BIGINTs as JavaScript STRINGS, while the JWT carries
  // a real number. "3" !== 3 would sign out the entire school.
