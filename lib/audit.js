 ...
 *
 * SIGNATURE: logAudit(entry, client) -- the entry object comes FIRST, because
 * almost no caller has a transaction. Some older documents show
 * logAudit(client, {...}); they are wrong. This file is the contract.
 */
